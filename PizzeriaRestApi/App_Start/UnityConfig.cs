...
namespace PizzeriaRestApi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<DbContext, PizzeriaDbContext>(new HierarchicalLifetimeManager());
            ...
            container.RegisterType<IPizzaService, PizzaServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<IFridgeService, FridgeServiceBD>(new HierarchicalLifetimeManager());
